...
@Named(value = "relControleParasitarioMB")
@ViewScoped
public class RelControleParasitarioMB extends BaseBeans {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3731900041842913906L;
	 ...
	 */
	public void result() {
		this.controleParazita = relProducaoFacade.relControleParasitario(rebanhosMarcados, inicio, fim);
	}
