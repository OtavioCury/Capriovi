...
@Named(value = "relCoberturaReprodutorMB")
@ViewScoped
public class RelCoberturaReprodutorMB extends BaseBeans {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4015539183536731092L;
	...
	private List<ResumoAnimalReprodutivo> animais;
	 ...
	 */
	public void result() {
		this.animais = relReproducaoFacade.relCoberturaReprodutor(rebanhosMarcados, inicio, fim);
	}
	...
	public List<ResumoAnimalReprodutivo> getAnimais() {
		return animais;
	}

	public void setAnimais(List<ResumoAnimalReprodutivo> animais) {
