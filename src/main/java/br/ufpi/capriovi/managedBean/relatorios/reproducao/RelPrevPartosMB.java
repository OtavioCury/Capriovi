...
@Named(value = "relPrevPartosMB")
@ViewScoped
public class RelPrevPartosMB implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -2574370412925017071L;
	 ...
	 */
	public void result() {
		manejos = relReproducaoFacade.relPrevPartos(rebanhosMarcados);
	}
