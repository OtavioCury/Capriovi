...
$(document).ready(function() {
    ...
    var Capriovi = {
        ...
        categoryLinks: $(".LinkPrincipalText"),
	...
	Capriovi.onWinResize();
	$(window).on("resize", function() {
        Capriovi.onWinResize();
    });
		
	Capriovi.menu.perfectScrollbar({
		wheelSpeed: 40,
		suppressScrollX:true
	});
    	
	// menu mouseenter & mouseleave actions start ----------------------------------
	Capriovi.menu.on("mouseenter", function() {
        Capriovi.highlightMenu();
	})
	.on("mouseleave", function() {
        Capriovi.unhighlightMenu();
	});
    ...
    if(lastTabHeader.hasClass('tab-doc')) {
     ...
     // Search ---------------------------------------
    Capriovi.searchInput.on('keyup', function(e) {
        Capriovi.hideSubMenus();
